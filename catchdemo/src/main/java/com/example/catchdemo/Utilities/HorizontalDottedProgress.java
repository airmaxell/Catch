...
public class HorizontalDottedProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(Color.parseColor("#b2ff0944"));
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        for(int i = 0; i < mDotAmount; i++ ){
            if(i == mDotPosition){
                canvas.drawCircle(15+(i*110), mBounceDotRadius, mBounceDotRadius, paint);
            }else {
                canvas.drawCircle(15+(i*110), mBounceDotRadius, mDotRadius, paint);
            }
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int calculatedWidth = (110*4) + 2 * mBounceDotRadius;
