...
public class DetailsFragment extends Fragment {
    ...
    private List<File> detailsImagesList;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layoutImages = (LinearLayout) view.findViewById(R.id.details_images);
        selectedImage = (AppCompatImageView) view.findViewById(R.id.details_image_selected);
        ...
        if(!detailsImagesList.isEmpty()) {
            selectImageFromPath(detailsImagesList.get(0).getAbsolutePath());
        }
    }
